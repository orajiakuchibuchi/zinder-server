          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <h1><a href="${url}">Zinder Reminder</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
            			<div class="text">
            				<h2>We will like to remind you of the ${job.title} ${job.type} starting in about 50 minutes time.</h2>
            			</div>
            		</td>
            	</tr>
            	<tr>
			          <td style="text-align: center;">
			          	<div class="text-author">
				          	...
				          	<h3 class="name">Sandra</h3>
				          	<span class="position">Support Team, Zinder</span>
				           	<p><a href="${url}" class="btn btn-primary">Confirm Availability</a></p>
				           	<p><a href="${url}" class="btn-custom">I will not make it</a></p>
			           	</div>
			          </td>
			        </tr>
            </table>
